...
async def chat_endpoint(request: ChatRequest):
    ...
    try:
        ...
        system_prompt = (
            f"You are Apex, a world-class AI assistant. Today is {datetime.now().strftime('%B %d, %Y')}. "
            "For events, information, or data not in your training set, you MUST rely on the provided context from search results and Wikipedia. "
            ...
            "7. **Knowledge Limitation**: If asked about recent events without context, clearly state your knowledge cutoff and suggest the user ask for updated information."
        )
